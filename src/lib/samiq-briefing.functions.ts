// Briefing ao abrir a Sami (Onda S3, D13): coleta agenda, tarefas vencidas e
// filas com a SESSÃO DO CORRETOR (RLS) e monta o resumo com a regra pura de
// samiq-briefing.ts. Não chama o modelo — não gasta cota nem entra em
// samiq_execucoes. É o "quem merece atenção hoje" da Elô, de graça.
