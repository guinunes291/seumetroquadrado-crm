...
/** Monta uma descrição em PT-BR do perfil do lead para o Match IA. */
 ...
 *  do lead — reusa o Match IA (buscarProjetosIA) na própria página do lead. */
      ...
      <CardContent className="space-y-2">
        ...
        {!mutation.data && !mutation.isPending && !mutation.error && (
          <p className="text-xs text-muted-foreground">
            Sugere os empreendimentos do catálogo com mais aderência ao perfil do lead.
          </p>
        )}
        {mutation.data && (
          <>
