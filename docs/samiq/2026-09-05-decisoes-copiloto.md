...
| **S2 — Escrita por proposta** | Entregue e mergeada (PR #175, 06/09/2026) | migration `20260907100000_samiq_copiloto_s2.sql`; `src/lib/samiq-propostas*.ts`, `samiq-executar.server.ts`, `samiq-confirmar.functions.ts`; `src/components/samiq/samiq-propostas-card.tsx`                             |
| **S3 — Presença**             | Entregue e mergeada (PR #176, 06/09/2026) | migration `20260908100000_samiq_copiloto_s3.sql`; `src/lib/samiq-briefing*.ts`; `src/components/samiq/abrir-samiq.ts`; `src/hooks/use-ditado.ts`; chips em Atender, dossiê e pós-chamada                                 |
| **S4 — Um cérebro**           | Entregue e mergeada (PR #177, 06/09/2026) | migration `20260909100000_samiq_copiloto_s4.sql`; `src/lib/samiq-core.server.ts` (cérebro único), `samiq-canal*.ts`, rotas `src/routes/api/sami/*`; contrato em `docs/integracoes/sami-whatsapp.md`                      |
| **S5 — Skills**               | Entregue e mergeada (PR #178, 06/09/2026) | migration `20260910100000_samiq_copiloto_s5.sql` (prompt v5); `src/lib/samiq-skills*.ts`: pré-análise MCMV (APROVE 2026), qualificação 7D, curador com estoque, preparador de visita; linha "visitas amanhã" no briefing |
