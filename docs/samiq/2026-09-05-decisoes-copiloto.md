...
| **S4 — Um cérebro**           | Em PR (06/09/2026)                        | migration `20260909100000_samiq_copiloto_s4.sql`; `src/lib/samiq-core.server.ts` (cérebro único), `samiq-canal*.ts`, rotas `src/routes/api/sami/*`; contrato em `docs/integracoes/sami-whatsapp.md` |
