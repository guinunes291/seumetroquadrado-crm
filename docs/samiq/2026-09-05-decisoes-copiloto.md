...
| **S3 — Presença**             | Em PR (06/09/2026)                        | migration `20260908100000_samiq_copiloto_s3.sql`; `src/lib/samiq-briefing*.ts`; `src/components/samiq/abrir-samiq.ts`; `src/hooks/use-ditado.ts`; chips em Atender, dossiê e pós-chamada     |
