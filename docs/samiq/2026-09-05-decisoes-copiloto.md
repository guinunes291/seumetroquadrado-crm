...
| **S5 — Skills**               | Em PR (06/09/2026)                        | migration `20260910100000_samiq_copiloto_s5.sql` (prompt v5); `src/lib/samiq-skills*.ts`: pré-análise MCMV (APROVE 2026), qualificação 7D, curador com estoque, preparador de visita; linha "visitas amanhã" no briefing |
