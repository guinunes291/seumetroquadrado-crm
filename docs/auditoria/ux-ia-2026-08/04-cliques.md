...
| 13 | Leads parados há mais de X dias | Leads → filtro de contato → "sem contato 30d" | **3** | 1 | ≤2 | 🔴 **X é fixo em 30 dias** (`leads.index.tsx:507, 588`). Não há como perguntar "parados há 7" ou "há 15". O Painel do Dia tem exceção "parado" com limiar de configuração (`gestao_limiar_parado`), mas é um valor global, não um filtro de consulta |
