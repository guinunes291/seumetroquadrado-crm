...
- [x] `materiais` → `projeto_materiais` (2026-09-13, Portal do Empreendimento: N materiais tipados por projeto, RLS gestão/time, ficha como página de produto — `docs/portal-empreendimento.md`).
- [ ] `construtoras`, `scripts_vendas`, `faq_chatbot`, `links_uteis`, `acessos_links`.
